 ...
 *
 * Generated types: ai-gateway, ajna, clerk, code, cowswap, database, discord, linear, math, pendle, protocol, resend, safe, sendgrid, sky, slack, telegram, uniswap, v0, web3, webflow, webhook, weth
 */
