 ...
 *
 * Generated types: ai-gateway, ajna, clerk, code, database, discord, linear, math, protocol, resend, safe, safe-wallet, sendgrid, sky, slack, telegram, v0, web3, webflow, webhook, weth
 */
