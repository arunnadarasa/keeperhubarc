...
export const PUBLIC_RPCS = {
  ...
  AVAX_MAINNET: "https://chain.techops.services/avax-mainnet",
  AVAX_MAINNET_FALLBACK: "https://api.avax.network/ext/bc/C/rpc",
  AVAX_FUJI: "https://chain.techops.services/avax-fuji",
  AVAX_FUJI_FALLBACK: "https://api.avax-test.network/ext/bc/C/rpc",
